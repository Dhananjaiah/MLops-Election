...
- [x] Distinguish between online (real-time) and batch (offline) ML systems
- [x] Understand the trade-offs of each approach
- [x] Choose the right architecture for different use cases

---

## Real-World Context

> **Story**: A company built a real-time fraud detection system that took 5 seconds to respond. They spent 3 months optimizing, only to realize most fraud isn't detected until the next day anyway. They should have built a batch system from the start.
>
> Understanding online vs batch ml systems (where your work fits) is essential for successful MLOps implementation.
...
This section covers the fundamental concepts of online vs batch ml systems (where your work fits).
...
1. **What is the main benefit of understanding online vs batch ml systems (where your work fits)?**
...
- Online vs Batch ML Systems (Where Your Work Fits) is fundamental to successful MLOps
...
→ Continue to **Lecture 3.6**: MLOps Responsibilities in Each Lifecycle Stage
