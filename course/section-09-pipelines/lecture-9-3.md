# Lecture 9.3 – Overview of Common Orchestrators (Airflow, Prefect, Kubeflow, Tekton)
...
![Diagram Placeholder](../../assets/diagrams/lecture-9-3-diagram.png)
...
→ Continue to **Lecture 9.4**: Designing a Training Pipeline for Our Project (Diagram)
