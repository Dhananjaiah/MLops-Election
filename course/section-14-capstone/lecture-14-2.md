# Lecture 14.2 – Walking Through the Code & Repos Structure
...
![Diagram Placeholder](../../assets/diagrams/lecture-14-2-diagram.png)
...
→ Continue to **Lecture 14.3**: Running the Full Pipeline: Data → Training → Registry → Deploy → Monitor
