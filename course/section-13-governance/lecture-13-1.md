# Lecture 13.1 – Access Control & Secrets Management (API Keys, DB Credentials)
...
![Diagram Placeholder](../../assets/diagrams/lecture-13-1-diagram.png)
...
→ Continue to **Lecture 13.2**: Compliance Basics (PII, Data Retention, Audit Logs)
